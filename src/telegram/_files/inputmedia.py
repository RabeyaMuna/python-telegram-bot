...
class InputMediaLivePhoto(InputMedia):
    ...
    Args:
        media (:obj:`str` | :term:`file object` | :class:`~telegram.InputFile` | :obj:`bytes` |             :class:`pathlib.Path` | :class:`telegram.PhotoSize`): Photo to send. |fileinputnopath|
            Lastly you can pass an existing :class:`telegram.PhotoSize` object to send.

            .. versionchanged:: 13.2
               Accept :obj:`bytes` as input.
        photo (:obj:`str` | :term:`file object` | :class:`~telegram.InputFile` | :obj:`bytes` |             :class:`pathlib.Path` | :class:`telegram.PhotoSize`): Photo to send. |fileinputnopath|
            Lastly you can pass an existing :class:`telegram.PhotoSize` object to send.
    ...
    Attributes:
        ...
        media (:obj:`str` | :class:`telegram.InputFile`): Photo to send.
        photo (:obj:`str` | :class:`telegram.InputFile`): Photo to send.
            This field is now ignored.
        caption (:obj:`str`): Optional. Caption of the photo to be sent,
            0-:tg-const:`telegram.constants.MessageLimit.CAPTION_LENGTH` characters
            after entities parsing.
    ...
    def __init__(
        self,
        media: Union[FileInput, "PhotoSize"],
        photo: Optional[Union[FileInput, "PhotoSize"]] = None,
        caption: Optional[str] = None,
        parse_mode: ODVInput[str] = DEFAULT_NONE,
        caption_entities: Optional[Sequence[MessageEntity]] = None,
        filename: Optional[str] = None,
        ...
        *,
        ...
        with self._unfrozen():
            self.has_spoiler: Optional[bool] = has_spoiler
            self.photo: Optional[Union[FileInput, PhotoSize]] = photo
            self.show_caption_above_media: Optional[bool] = show_caption_above_media
